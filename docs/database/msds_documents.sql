...
-- membuang struktur untuk table rhinedottir.msds_documents
CREATE TABLE IF NOT EXISTS `msds_documents` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `reagen_guid` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `file_path` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `file_name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `file_size` bigint unsigned NOT NULL,
  `file_type` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL,
  `title` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `trainers` json DEFAULT NULL,
  `uploaded_by` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `msds_documents_reagen_guid_index` (`reagen_guid`),
  KEY `idx_uploaded_by` (`uploaded_by`),
  CONSTRAINT `msds_documents_reagen_guid_foreign` FOREIGN KEY (`reagen_guid`) REFERENCES `reagens` (`guid`) ON DELETE CASCADE
