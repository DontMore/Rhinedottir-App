        ...
        <div class="lg:col-span-2 bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
            ...
            <div class="divide-y divide-gray-100">
                ...
                <div class="px-6 py-4 grid grid-cols-1 sm:grid-cols-3 gap-2 items-center">
                    ...
                    <span class="sm:col-span-2">
                        <a href="{{ route('management-stock.msds', ['guid' => $reagen->guid]) }}" target="_blank" class="inline-flex items-center px-3 py-1.5 text-xs font-bold text-emerald-700 bg-emerald-50 hover:bg-emerald-100 border border-emerald-100 rounded-lg transition-all">
