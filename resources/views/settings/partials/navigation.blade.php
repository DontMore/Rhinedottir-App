<div class="w-full md:w-64 flex-shrink-0">
    <nav class="space-y-1">
        <a href="{{ route('settings.index') }}" 
           class="{{ request()->routeIs('settings.index') ? 'bg-blue-50 text-blue-700 border-blue-500' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900 border-transparent' }} flex items-center px-4 py-3 text-sm font-medium border-l-4 transition-all duration-200">
            <svg class="mr-3 h-5 w-5 {{ request()->routeIs('settings.index') ? 'text-blue-500' : 'text-gray-400' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
