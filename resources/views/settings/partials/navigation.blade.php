<div class="w-full md:w-64 flex-shrink-0">
    <nav class="space-y-1">
        ...
        <!-- Tambahkan item ini di dalam daftar menu navigasi settings -->
        <a href="{{ route('settings.scheduler') }}"
            class="{{ request()->routeIs('settings.scheduler') ? 'bg-blue-50 text-blue-700 border-blue-200' : 'text-gray-700 hover:bg-gray-50 hover:text-gray-900 border-transparent' }} flex items-center px-4 py-3 text-sm font-medium border-l-4 transition-colors">
