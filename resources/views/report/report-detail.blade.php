        ...
        <div class="p-6">
            <div class="flex justify-between items-center mb-6">
                ...
                <div class="flex gap-2">
                    <a href="{{ route('report.logbook-pdf') }}?{{ http_build_query(request()->all()) }}" 
                       target="_blank"
                    ...
                    <a href="{{ route('report.logbook-excel') }}?{{ http_build_query(request()->all()) }}" 
            ...
            <form class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                ...
                <div>
                    ...
                    <select name="reagen" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
