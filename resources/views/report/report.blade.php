        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 hover:-translate-y-1 transition-transform duration-200">
            <div class="p-6">
                <div class="flex items-center gap-3 mb-4">
                    ...
                    <h3 class="text-lg font-semibold text-gray-900">Annual Reagen Usage</h3>
                </div>
                <p class="text-sm text-gray-500 mb-4">Ringkasan semua reagen dengan signal word, hazard symbol, dan total pemakaian tahun berjalan.</p>
                <a href="{{ route('report.reagen-annual-usage') }}" class="inline-flex w-full items-center justify-center px-4 py-2 bg-amber-600 text-white text-sm font-medium rounded-lg hover:bg-amber-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-amber-500">
                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/>
                    </svg>
